...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/09/05 12:19:07 by smanta            #+#    #+#              #
#    Updated: 2019/09/19 17:35:03 by smanta           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c \
	  ...
	  ft_lstiter.c ft_lstmap.c ft_lstadd_back.c ft_lstsize.c \
	  ft_lstlast.c ft_lstat.c ft_lstreverse.c ft_lstfind.c
OBJ = $(SRC:.c=.o)
HEADER = ./libft.h
...
%.o : %.c $(HEADER)
	gcc -c $< -I$(HEADER) -Wall -Wextra -Werror
